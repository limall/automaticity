//
//  ContinueFangsongItmeView.swift
//  Shenghuoguanli
//
...
struct ContinueFangsongItemView: View {
    let title:String
    let rate:String
    ...
    var body: some View {
        ZStack{
            ...
            VStack(spacing:screen.width*0.077){
                ...
                HStack{
                    Button(action: {
                        Action.sharedInstance.startFangsong(title: title)
                    ...
                    Button(action: {
                        Action.sharedInstance.endFangsong(title: title)
                    }) {
                        ZStack{
                            Rectangle()
...
struct ContinueFangsongItemView_Previews: PreviewProvider {
    static var previews: some View {
        ContinueFangsongItemView(title: "刷抖音", rate: "60", time: "21日15:23",isDoing: true, todayTime: "100", todayScore: "150",store: DataStore())
    }
}
