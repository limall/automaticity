    ...
    var body: some View {
        ZStack{
            ...
            VStack(spacing:screen.width*0.077){
                ...
                HStack{
                    Button(action: {
                        Action.sharedInstance.onceNuli(title: title, times: 1)
...
struct OnceNuliItemView_Previews: PreviewProvider {
    static var previews: some View {
        OnceNuliItemView(title: "当天工作时间达360分钟", rate: "20", lastTime: "3月1号",store: DataStore())
    }
}
